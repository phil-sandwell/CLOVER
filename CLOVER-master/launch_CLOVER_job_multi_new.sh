...
CLOVER_PATH='/home/jb2618/CLOVER-master/'
...
These jobs must contain the a line 'location=LOCATION_NAME_HERE' in the first few lines so that the script knows where to get Location details from.cp -r /home/jb2618/CLOVER-master/Locations/$LOCATION/ CLOVER/Locations/
...
mkdir CLOVER/
cp -r /home/jb2618/CLOVER-master/Scripts CLOVER/
...
do
 ...
 if [ ! -d CLOVER/Locations/$LOCATION/ ]
  then
  cp -r /home/jb2618/CLOVER-master/Locations/$LOCATION/ CLOVER/Locations/
 fi
 
mkdir ${BASENAME}/
 cp -r CLOVER/* ${BASENAME}
 mkdir -p /home/jb2618/CLOVER-master/Results/$BASENAME

cp -r /home/jb2618/CLOVER-master/Jobs/$BASENAME/ ${BASENAME}/Jobs/
...
cp -r ${BASENAME}/Locations/$LOCATION/Simulation/Saved\ simulations/ /home/jb2618/CLOVER-master/Results/$BASENAME
cp -r ${BASENAME}/Locations/$LOCATION/Optimisation/Saved\ optimisations/ /home/jb2618/CLOVER-master/Results/$BASENAME
